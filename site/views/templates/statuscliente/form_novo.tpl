    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idStatusCliente}>0} {$registro.dsStatusCliente|default:''} {else} Inclus&atilde;o de Statuss de Clientes {/if}</h1></tt>
            </div>          
            ...
            <form name="frm-statuscliente" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idStatusCliente}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idStatusCliente" id="idStatusCliente" value="{$registro.idStatusCliente}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsStatusCliente|default:''}" >           
                </div> 
                <br>            
